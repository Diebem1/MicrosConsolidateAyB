    ...
    public class ConfigClass
    {
        public Config setConfig(ref Config cfn, ref List<Emisor> emisorCfnList, string path)
        {
            try
            {
                ...
                if (String.IsNullOrEmpty(cfn.ClaveFacto))
                    throw new Exception("Es requerido campo 'ClaveFacto' en configuración");

                if (String.IsNullOrEmpty(cfn.CentroConsumo))
                    throw new Exception("Es requerido campo 'CentroConsumo' en configuración");
